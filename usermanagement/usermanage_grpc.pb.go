...
type UserManagementClient interface {
	...
	CreatePcSpecs(ctx context.Context, in *PcSpecs, opts ...grpc.CallOption) (*PcSpecsResponse, error)
}
...
func (c *userManagementClient) CreatePcSpecs(ctx context.Context, in *PcSpecs, opts ...grpc.CallOption) (*PcSpecsResponse, error) {
	out := new(PcSpecsResponse)
	err := c.cc.Invoke(ctx, "/usermanagement.UserManagement/CreatePcSpecs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserManagementServer interface {
	...
	CreatePcSpecs(context.Context, *PcSpecs) (*PcSpecsResponse, error)
...
func (UnimplementedUserManagementServer) CreatePcSpecs(context.Context, *PcSpecs) (*PcSpecsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreatePcSpecs not implemented")
}
...
func _UserManagement_CreatePcSpecs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PcSpecs)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserManagementServer).CreatePcSpecs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/usermanagement.UserManagement/CreatePcSpecs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserManagementServer).CreatePcSpecs(ctx, req.(*PcSpecs))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserManagement_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreatePcSpecs",
			Handler:    _UserManagement_CreatePcSpecs_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "usermanagement/usermanage.proto",
}
